...
namespace RabbitMQWeb.Watermark.Controllers
{
	public class ProductsController : Controller
	{
		...
		public async Task<IActionResult> Create([Bind("Id,Stock,Name,Price,ImageUrl")] Product product, IFormFile imageFile)
		{
		...
		[HttpPost]
		[ValidateAntiForgeryToken]
		public async Task<IActionResult> Edit(int id, [Bind("Id,Stock,Name,Price,ImageUrl")] Product product)
		{
			if (id != product.Id)
			{
				return NotFound();
